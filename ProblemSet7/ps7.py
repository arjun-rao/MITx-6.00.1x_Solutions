...
class WordTrigger(Trigger):
    """
    It has one new method, isWordIn, which takes in one string argument text. 
...
def main_thread(master):
    ...
    try:
        ...
        triggerlist = readTriggerConfig("/Users/arjun/files/Courses/MIT600x/ProblemSet7/triggers.txt")
